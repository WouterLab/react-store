...
import AboutImgLoader from "../../components/AboutImgLoader/AboutImgLoader";
import TextBlock from "../../components/TextBlock/TextBlock";
import "./About.css";

const About = () => {
  const AboutImg = React.lazy(() =>
    import("../../components/AboutImg/AboutImg")
  );
  const whyStore = [
    {
  ...
  return (
    <div className="about roll-out" key="about">
      <div className="about__main">
        ...
        <Suspense fallback={<AboutImgLoader />}>
          <AboutImg />
        </Suspense>
      </div>
    </div>
